...
# TRZECI strumien, i jedyne zrodlo mapy podsiec->siec (DEC-42). Bez niego dopasowanie maszyny do sieci
...
def policz_okna_sieci(wpisy: list[dict], egzekwowane: set[str], okno_s: int) -> dict:
    ...
    SIEC ODCZYTUJE SIE NA DWA SPOSOBY, A DOPIERO ICH BRAK URUCHAMIA (b) — DEC-42. Wpis maszyny w sieci
    ...
    if not zrodlo:
        ...
        if okna_sieci is not None:
            ...
            for s in okna_sieci["szczegoly"]:
                ...
                #
                # ODKAD JEST MAPA PODSIEC->SIEC (DEC-42) TA SCIEZKA JEST WYJATKIEM, A NIE DOMYSLNA — ale
