...
## DEC-46 — Dryf to DWA pytania: obiekt zmieniony i obiekt DOPISANY; `terraform plan` odpowiada tylko na pierwsze
...
## DEC-47 — Każdy kanał otwierający pull requesta mintuje token Appa — również ten, który ZDEJMUJE ochronę
...
`skipped`, a przebieg zielony. To jest ta sama klasa defektu, co detektor dryfu ślepy na dopisek (DEC-46):
