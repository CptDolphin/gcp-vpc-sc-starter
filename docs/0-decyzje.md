# Decyzje, na których stoi ten starter (DEC-1…DEC-17)

Siedemnaście rozstrzygnięć, które określają kształt repozytorium. Kod odsyła tutaj skrótem `DEC-1`…`DEC-17` — jeśli komentarz
...
## DEC-17 — Bramka promocji pyta o PRZEJŚCIE do `enforced`, a stanem odniesienia jest opublikowany kontrakt
