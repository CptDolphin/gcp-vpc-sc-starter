...
|---|---|
| [0 — Decyzje (DEC-1…DEC-14)](0-decyzje.md) | pytasz „dlaczego akurat tak"; przed każdą zmianą kształtu repo |
...
(`DEC-1`…`DEC-14`). Kod odsyła do nich tym skrótem; numeracja `DEC-` jest rozłączna z `D1`…`D5`,
